...
@interface Muse_FranceObject : KrollCoverageObject {
#else
@interface Muse_FranceObject : KrollObject {
#endif
@private
...
extern NSString * Muse_France$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Muse_FranceObject *_muse_france;
    KrollObject* console;
	BOOL shutdown;
