...
//@interface Muse_FranceObject : NSObject
//@end

@interface Muse_FranceObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Muse_FranceObject class]])
		{
			for (NSString *key in [[(Muse_FranceObject*)o modules] allKeys])
			{
