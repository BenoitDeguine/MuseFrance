...
// in simulator we redefine to format for Muse_France Developer console
...
{\
	NSString * exceptionName = [@"org.muse_france." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.muse_france";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMuse_FranceNativeItemNone = -1, 
	UIMuse_FranceNativeItemSpinner = -2,
	UIMuse_FranceNativeItemProgressBar = -3,
	
	UIMuse_FranceNativeItemSlider = -4,
	UIMuse_FranceNativeItemSwitch = -5,
	UIMuse_FranceNativeItemMultiButton = -6,
	UIMuse_FranceNativeItemSegmented = -7,
	
	UIMuse_FranceNativeItemTextView = -8,
	UIMuse_FranceNativeItemTextField = -9,
	UIMuse_FranceNativeItemSearchBar = -10,
	
	UIMuse_FranceNativeItemPicker = -11,
	UIMuse_FranceNativeItemDatePicker = -12,
	
	UIMuse_FranceNativeItemInfoLight = -13,
	UIMuse_FranceNativeItemInfoDark = -14,
	
	UIMuse_FranceNativeItemDisclosure = -15,
	
	UIMuse_FranceNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Muse_France instances of
