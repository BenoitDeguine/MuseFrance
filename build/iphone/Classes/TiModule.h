...
/**
 The base class for all Muse_France modules
 */
...
/**
 Muse_France Platform calls this method on startup.
 */
-(void)startup;

/**
 Muse_France Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Muse_France Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Muse_France Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Muse_France Platform calls this method on resume.
 @param sender The sender of the event.
 */
