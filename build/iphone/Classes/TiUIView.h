...
/**
 Base class for all Muse_France views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Muse_France view hierarchy (such as wrapped iOS UIViews) was touched.
